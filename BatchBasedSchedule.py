...
if __name__ == '__main__':
    ...
    calAverageValueOfWindowBasedListForDiffClusterSize([1, 2, 3, 4], 2000, "workloadSet1", 2000, 1, 100, 10, [50, 100, 200, 300, 400, 500], "old")
